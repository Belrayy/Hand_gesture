...
class GestureRecognitionApp:
    ...
    def preview_video(self):
        ...
        if ret:
            ...
            if self.is_recording:
                ...
                if len(self.frame_buffer) == 8 and self.frame_counter % self.prediction_interval == 0:
    ...
    def update_prediction_ui(self, prediction, confidence):
        ...
        if (current_time - self.last_prediction_time > 0.5) or (prediction != self.current_prediction and confidence > 50):
